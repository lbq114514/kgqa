...
BASE_CONFIG="${BASE_CONFIG:-outputs/runtime_configs/cwq_single_relation_beam.yaml}"
SPLIT="${SPLIT:-test}"
INDEX="${INDEX:-0}"
...
RUN_NAME="cwq_single_relation_beam_index${INDEX}"
...
BASE_CONFIG="$(resolve_project_path "$BASE_CONFIG")"
...
config.setdefault("retrieval", {}).setdefault("search", {})["subquestion_explorer"] = "relation_beam"
